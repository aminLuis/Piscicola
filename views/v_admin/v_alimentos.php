...
require('../../controllers/c_admin/c_listarAlimentos.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Provisión alimentos</title>
     ...
     <div class="container">
          ...
          <div class="card">
                 ...
                 <div class="card-header">
                   <h5>Registro de alimento</h5>
                 </div>

               <div class="container">

                    <form method="POST" action="../../models/m_admin/m_alimentos.php">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                              <label>Costo flete por Kg</label>
                              <input type="number" class="form-control" name="flete">
                            </div>
                    ...
                    <table class="table table-hover" id="tabla">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Total kilogramos (Kg)</th>
                                <th scope="col">Costo kilogramo</th>
                      ...
                      <tbody>
                        ...
                        ?>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a href="./v_editarAlimento.php?codigo=<?php echo $row['codigo'] ?>">
                                      ...
                                      <?php
                                        if($varSesion['tipo']=='admin' || $varSesion['tipo']=='root'){
                                      ?>
                                      <a href="./v_eliminarAlimento.php?codigo=<?php echo $row['codigo'] ?>">
