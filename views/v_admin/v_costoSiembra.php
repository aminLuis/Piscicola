...
require('../../controllers/c_admin/c_listarCostosFijos.php');
...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <a class="navbar-brand" >Costos siembra</a>
            ...
            <div class="btn-group dropleft">
              ...
              <?php
               ...
               ?>
                ...
                <a class="dropdown-item" href="./v_configuracion.php">Crear siembra</a>
    ...
    <div class="container">
          ...
          <div class="card">
                ...
                <div class="card-header">
                    <h5>Costos siembra</h5>
                </div>

              <div class="container">

                    <form method="POST" action="../../models/m_admin/m_costoSiembra.php">
                              ...
                              <div class="row">
                                   ...
                                   <div class="col">
                                         ...
                                         <input type="number" class="form-control" step="any" name="nomina" required>
                                   </div>

                                   <div class="col">
                                         <label>Asistencia técnica</label>
                                         <input type="number" class="form-control" step="any" name="asistencia" required>
                                   </div>
                              ...
                              <div class="row">
                                    ...
                                    <input type="number" class="form-control" step="any" name="jornales" required>
                                    </div>

                                    <div class="col">
                                    <label>Combustible</label>
                                    <input type="number" class="form-control" step="any" name="combustible" required>
                                    </div>

                                    <div class="col">
                                    <label>Tiros</label>
                                    <input type="number" class="form-control" step="any" name="tiros" required>
                                    </div>
                              ...
                              <div class="row">
                                    ...
                                    <div class="col">
                                    <label>Energia</label>
                                    <input type="number" class="form-control" step="any" name="energia" required>
                                    </div>
                      ...
                      <table class="table table-hover" id="tabla">
                          ...
                          <thead>
                              <tr>
                                 ...
                                 <th scope="col">Nomina fija</th>
                                 <th scope="col">Asistencia técnica</th>
                                 <th scope="col">Jornales</th>
                            ...
                            ?>
                                  ...
                                  <tr>
                                      ...
                                      <?php
                                          if($varSesion['tipo']=='admin' || $varSesion['tipo']=='root'){
                                        ?>
                                         <a href="./v_editarCostosFijos.php?codigo=<?php echo $row['codigo'] ?>">
                                            <button class="btn btn-warning"><i class="far fa-edit"></i></button>
                                         </a>

                                         <a href="./v_eliminarCostoFijo.php?codigo=<?php echo $row['codigo'] ?>">
