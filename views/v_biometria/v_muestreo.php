...
require('../../controllers/c_biometria/c_listar.php');
...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <a class="navbar-brand" ><h5>Biometría</h5></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <button type="button" class="btn btn-dark" onclick="mostrarMuestras();">Muestreo</button>
          <button type="button" class="btn btn-dark" style="margin-left: 10px;" onclick="mostrarLagos();">Lagos</button>
...
<div class="container">
  ...
  <div class="card">
    ...
    <div class="cardbody">
      ...
      <section id="muestras" style="display: block;">
        
                <div class="card-header">
                     <h5>Parámetros muestras</h5>
                 </div>
        <div class="container">
         
 
              <form method="POST" action="../../models/m_biometria/m_guardar.php">
                            ...
                            <div class="row">
                              ...
                              <div class="col">
                                    ...
                                    <input type="number" step="any" class="form-control" name="porcentaje" required>
                              </div>

                              <div class="col">
                                      <label>Ajuste</label>
                                      <input type="number" step="any" class="form-control" name="ajuste" value="0" readonly>
                                </div>
             ...
             <table class="table table-hover" id="tabla">
               ...
               <thead class="">
                   ...
                   <tr>
                     ...
                     <th scope="col">Número de animales</th>
               ...
               ?>  
                   ...
                   <tr>
                     ...
                     <td>
                       ...
                       <a href="../../views/v_biometria/v_editar.php?codigo=<?php echo $row['codigo'] ?>">
                       ...
                       <a href="../v_biometria/v_eliminar.php?codigo=<?php echo $row['codigo'] ?>">
      ...
      <section id="lagos" style="display: none;">

               <div class="card-header">
                   <h5>Información por lago</h5>
               </div>
      ...
      <div class="container">
          ...
          ?>
                 ...
                 <form method="POST" action="../../views/v_biometria/v_detalles">

                      <div class="row">
                    
                            <div class="col">
                              <label>Lago</label>
                              <input type="text" name="lago" class="form-control" value="<?php echo $lago ?>" readonly>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <button onclick="mostrarLagos();" class="btn btn-info" style="margin-top:30px">Ver detalles</button>
...
<script src="../../assets/javaScript/biometria.js"></script>
