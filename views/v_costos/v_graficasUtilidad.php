...
require('../../models/m_graficasCostos/m_linealUtilidad.php');
?>
...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <a class="navbar-brand" >Gráfica - utilidad</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="btn-group dropleft">
              ...
              ?>
                ...
                <a class="dropdown-item" href="./v_historialCostos.php">Volver a historial</a>
...
<body>
      ...
      <div class="card">
                  ...
                  <h6>Utilidades por siembra</h6>
                  </div>
                  
                      <div class="card-body">
                          
                      <div id="linealUtilidad"></div>
...
<!-- Script para gráfica siembra Vs utilidad  !-->
<script>
    ...
    Y = graficaLineal('<?php echo $jsonUtilidad ?>');
    ...
    Plotly.newPlot('linealUtilidad', data);
