...
require('../../controllers/c_costo/c_historialCostos.php');
?>
...
<head>
    ...
    <title>Historial costos</title>

    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <a class="navbar-brand" ><h5>Historial</h5></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="btn-group dropleft">
              ...
              ?>
                ...
                <a class="dropdown-item" href="./v_graficasUtilidad.php">Gráfica utilidades</a>
                <a class="dropdown-item" href="./v_seleccionLago.php">Gráfica costo lago</a>
          ...
          <div class="card">
              <div class="card-header">
               ...
               <div class="container">
                            ...
                            <table class="table table-hover table" id="tabla">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?php echo number_format($row['costoKilo'],3,",",".")?> </td>
                                        <td> <?php echo $row['fecha'] ?> </td>
                                        <td>
                                            <a href="./v_detallesCosto.php?lago=<?php echo $row['lago'] ?>&siembra=<?php echo $row['siembra'] ?>">
                                                <button class="btn btn-primary" style="width:45px">
                                            ...
                                            <a href="./v_editarCosto.php?lago=<?php echo $row['lago'] ?>&siembra=<?php echo $row['siembra'] ?>">
                                                <button class="btn btn-warning">
                                                <i class="far fa-edit"></i>
                                                </button>
                                            </a>
                                            <a href="./v_eliminarCosto.php?lago=<?php echo $row['lago'] ?>&siembra=<?php echo $row['siembra'] ?>">
