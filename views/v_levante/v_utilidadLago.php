...
require('../../controllers/c_levante/c_utilidadLago.php');
?>
...
<head>
    ...
    <title>Utilidad lago</title>

    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <a class="navbar-brand" ><h5>Levante - utilidad</h5></a>
